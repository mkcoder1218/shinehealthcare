          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="max-w-2xl animate-fade-in-up">
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-6 shadow-sm hover:shadow-md transition-all">
                ...
                #1 Rated Healthcare Provider
              </div>
              <h1 className="text-5xl lg:text-7xl font-bold text-slate-900 leading-[1.1] mb-6 tracking-tight">
                Your Health, Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Masterpiece</span>
              </h1>
              <p className="text-lg lg:text-xl text-slate-600 mb-8 leading-relaxed max-w-lg">
                Experience the future of healthcare today. Compassionate professionals, cutting-edge technology, and a commitment to your well-being.
              </p>
              ...
              <div className="mt-12 flex items-center gap-8 text-sm font-medium text-slate-500 animate-fade-in delay-300">
                <div className="flex items-center gap-2 bg-white/50 px-3 py-2 rounded-lg border border-slate-100 shadow-sm">
                  <div className="p-1 bg-green-100 rounded-full text-green-600"><CheckCircle size={14} /></div> 24/7 Support
                </div>
                <div className="flex items-center gap-2 bg-white/50 px-3 py-2 rounded-lg border border-slate-100 shadow-sm">
                  <div className="p-1 bg-blue-100 rounded-full text-blue-600"><CheckCircle size={14} /></div> Expert Doctors
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 -mt-32 relative z-30">
            <div className="group p-8 bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_rgba(59,130,246,0.15)] transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-100 border border-slate-50">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-blue-600 transition-colors">24/7 Availability</h3>
              <p className="text-slate-600 leading-relaxed">Our medical team is available around the clock to handle any emergency or routine checkup you might need.</p>
            </div>
            ...
            <div className="group p-8 bg-blue-600 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-200 text-white relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-3 relative z-10">Expert Specialists</h3>
              <p className="text-blue-100 leading-relaxed relative z-10">Access to highly qualified doctors and specialists across various fields of medicine under one roof.</p>
            </div>
            ...
            <div className="group p-8 bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_60px_rgba(20,184,166,0.15)] transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up delay-300 border border-slate-50">
              ...
              <h3 className="text-2xl font-bold text-slate-900 mb-3 group-hover:text-teal-600 transition-colors">Quality Care</h3>
              <p className="text-slate-600 leading-relaxed">We adhere to the highest international standards of medical safety and patient care protocols.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative animate-slide-in-left group">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white/95 backdrop-blur-sm p-8 rounded-2xl text-center shadow-2xl border border-white/50 z-20 hover:scale-105 transition-transform duration-300">
                <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500 mb-2">25+</div>
                <div className="text-slate-800 font-bold text-lg uppercase tracking-wide">Years Experience</div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2 animate-fade-in delay-200">
              <h4 className="text-blue-600 font-bold uppercase tracking-wider mb-2 flex items-center gap-2">
                <span className="w-8 h-0.5 bg-blue-600 rounded-full"></span> About Us
              </h4>
              <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 mb-6 leading-tight">Providing Medical Care for The Sickest In Our Community</h2>
              <p className="text-slate-600 mb-8 text-lg leading-relaxed">
                Shine Health Care was founded with a simple yet powerful mission: to provide accessible, high-quality healthcare to everyone. We believe that healing goes beyond prescriptions; it requires empathy, understanding, and a human touch.
              </p>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-slate-700 font-medium text-lg">Modern Medical Facilities</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shadow-sm"><ArrowRight size={16} /></div>
                  <span className="text-slate-700 font-medium text-lg">Experienced Medical Team</span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 shadow-sm"><ArrowRight size={16} /></div>
                  <span className="text-slate-700 font-medium text-lg">Patient-Centered Approach</span>
                </li>
              </ul>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in-up">
             <h4 className="text-blue-600 font-bold uppercase tracking-wider mb-2 flex items-center justify-center gap-2">
               <span className="w-8 h-0.5 bg-blue-600 rounded-full"></span> Testimonials <span className="w-8 h-0.5 bg-blue-600 rounded-full"></span>
             </h4>
            <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 mb-4">What Our Patients Say</h2>
            <p className="text-slate-600 text-lg">Real stories from people whose lives have been touched by our care.</p>
          </div>
      ...
      <section className="py-24 bg-blue-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-1 rounded-full text-sm font-medium mb-6 border border-white/20 backdrop-blur-md">
            <UserPlus size={16} /> New Patients Welcome
          </div>
          <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6 animate-fade-in-up">Ready to prioritize your health?</h2>
          <p className="text-blue-100 text-lg lg:text-xl mb-12 max-w-2xl mx-auto animate-fade-in-up delay-100">Schedule your appointment today and experience the Shine Health Care difference. Your journey to better health starts here.</p>
