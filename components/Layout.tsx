...
import { Menu, X, HeartPulse, Phone, Mail, MapPin, Facebook, Twitter, Linkedin, Instagram, ArrowRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex space-x-8">
            ...
            <div className="flex items-center space-x-2 hover:text-white transition-colors cursor-pointer">
              ...
              <span>contact@shinehealthcare.com</span>
            </div>
          </div>
          <div className="flex space-x-6">
            <span className="hover:text-blue-400 cursor-pointer transition-colors font-medium">Emergency: 911</span>
            <span className="hover:text-blue-400 cursor-pointer transition-colors font-medium">Patient Portal</span>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-slate-900 text-slate-300 pt-20 pb-10 border-t border-slate-800">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-16">
            ...
            <div className="space-y-6">
              ...
              <p className="leading-relaxed text-slate-400">
                Dedicated to providing world-class healthcare with a personal touch. Your health is our priority, and your smile is our reward.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['About Us', 'Our Services', 'Find a Doctor', 'Book Appointment', 'Patient Portal'].map((link, i) => (
                   <li key={i}>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Cardiology', 'Neurology', 'Pediatrics', 'Orthopedics', 'Dental Care', 'Emergency'].map((dept, i) => (
                  <li key={i}>
                    <Link to="/services" className="hover:text-blue-400 transition-colors flex items-center gap-2 group">
                      <span className="w-1.5 h-1.5 rounded-full bg-slate-600 group-hover:bg-blue-400 transition-colors"></span>
                      {dept}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-5">
                <li className="flex items-start space-x-4 group">
                  ...
                  <span className="text-slate-400 group-hover:text-slate-300 transition-colors">123 Medical Center Dr.<br />Wellness City, HC 90210</span>
                </li>
                <li className="flex items-center space-x-4 group">
                  <div className="bg-slate-800 p-2 rounded-lg text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    <Phone size={18} />
                  </div>
                  <span className="text-slate-400 group-hover:text-slate-300 transition-colors">+1 (555) 123-4567</span>
                </li>
                <li className="flex items-center space-x-4 group">
                  <div className="bg-slate-800 p-2 rounded-lg text-blue-500 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                    <Mail size={18} />
                  </div>
                  <span className="text-slate-400 group-hover:text-slate-300 transition-colors">contact@shinehealthcare.com</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
            <p>&copy; {new Date().getFullYear()} Shine Health Care. All rights reserved.</p>
